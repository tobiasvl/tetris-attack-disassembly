...
VBlankInterrupt::
    jp   Jump_000_0297                            ; $0040: $C3 $97 $02
...
LCDCInterrupt::
    jp   Jump_000_1C90                            ; $0048: $C3 $90 $1C
...
TimerOverflowInterrupt::
    jp   Jump_000_0D7E                            ; $0050: $C3 $7E $0D
...
SerialTransferCompleteInterrupt::
    jp   Jump_000_0CE2                            ; $0058: $C3 $E2 $0C
...
Call_000_0187:
    ...
    dec  a                                        ; $018C: $3D
    nop                                           ; $018D: $00
    ld   bc, $0005                                ; $018E: $01 $05 $00
    nop                                           ; $0191: $00
    ld   b, d                                     ; $0192: $42
    ld   a, [hl+]                                 ; $0193: $2A
    ld   [hl], $00                                ; $0194: $36 $00
    ld   bc, $0003                                ; $0196: $01 $03 $00
    nop                                           ; $0199: $00
    scf                                           ; $019A: $37
    ld   a, [hl+]                                 ; $019B: $2A
    inc  [hl]                                     ; $019C: $34
    nop                                           ; $019D: $00
    ld   bc, $0000                                ; $019E: $01 $00 $00
    nop                                           ; $01A1: $00
    dec  a                                        ; $01A2: $3D
    ld   a, [hl+]                                 ; $01A3: $2A
    inc  sp                                       ; $01A4: $33
...
jr_000_0253:
    ...
    call Call_000_0400                            ; $0256: $CD $00 $04
...
jr_000_026B:
    call Call_000_0E86                            ; $026B: $CD $86 $0E
...
Call_000_02B3:
    ...
    rst  $28                                      ; $02BA: $EF
    ld   bc, $D920                                ; $02BB: $01 $20 $D9
    ld   [bc], a                                  ; $02BE: $02
    ld   [$0102], a                               ; $02BF: $EA $02 $01
...
Call_000_0307:
    rst  $28                                      ; $0307: $EF
    ld   a, e                                     ; $0308: $7B
    ld   [$06A8], sp                              ; $0309: $08 $A8 $06

Call_000_030C:
Jump_000_030C:
    adc  a                                        ; $030C: $8F
    ld   [$08E0], sp                              ; $030D: $08 $E0 $08
    DB   $F4                                      ; $0310: $F4
    ld   [$0908], sp                              ; $0311: $08 $08 $09
    xor  a                                        ; $0314: $AF
...
Call_000_0351:
    ...
    cp   b                                        ; $035F: $B8
    inc  bc                                       ; $0360: $03
    jp   z, Jump_000_2D03                         ; $0361: $CA $03 $2D
...
Call_000_0743:
    ...
    cp   $06                                      ; $076C: $FE $06
    call z, Call_000_0EC1                         ; $076E: $CC $C1 $0E
...
Call_000_0BC9:
    ...
    call Call_000_14DF                            ; $0BD3: $CD $DF $14
    pop  af                                       ; $0BD6: $F1
...
Call_000_0CFE:
    ...
    jp   Jump_000_0D79                            ; $0D11: $C3 $79 $0D
...
jr_000_0D28:
    ...
    jp   Jump_000_0D79                            ; $0D2F: $C3 $79 $0D
...
jr_000_0F43:
    ...
    call Call_000_0DEB                            ; $0F4C: $CD $EB $0D
...
jr_000_0F4F:
    ...
    call Call_000_0E86                            ; $0F55: $CD $86 $0E
...
jr_000_0FBC:
    ...
    jp   Jump_000_0EC1                            ; $0FC6: $C3 $C1 $0E
...
Call_000_1A76:
    ...
    call Call_000_043B                            ; $1A86: $CD $3B $04
    pop  af                                       ; $1A89: $F1
...
Call_000_1ABE:
    ...
    call Call_000_043B                            ; $1ACE: $CD $3B $04
    pop  af                                       ; $1AD1: $F1
...
Call_000_1B13:
    ...
    call Call_000_043B                            ; $1B16: $CD $3B $04
    pop  af                                       ; $1B19: $F1
...
Call_000_1B4E:
    ...
    call Call_000_043B                            ; $1B5E: $CD $3B $04
    pop  af                                       ; $1B61: $F1
...
Call_000_1B96:
    ...
    call Call_000_043B                            ; $1BA6: $CD $3B $04
    pop  af                                       ; $1BA9: $F1
...
Call_000_1BC7:
    ...
    call Call_000_043B                            ; $1BD4: $CD $3B $04
    pop  af                                       ; $1BD7: $F1
...
Call_000_1BDE:
    ...
    call Call_000_043B                            ; $1BEB: $CD $3B $04
    pop  af                                       ; $1BEE: $F1
...
Call_000_1BF5:
    ...
    call Call_000_043B                            ; $1C02: $CD $3B $04
    pop  af                                       ; $1C05: $F1
...
Call_000_1C79:
    ...
    call Call_000_043B                            ; $1C86: $CD $3B $04
    pop  af                                       ; $1C89: $F1
...
Jump_000_1FF8:
    ...
    rst  $28                                      ; $2004: $EF
    ld   de, $2520                                ; $2005: $11 $20 $25
    jr   nz, jr_000_2043                          ; $2008: $20 $39

    jr   nz, @+$4F                                ; $200A: $20 $4D

    jr   nz, jr_000_206F                          ; $200C: $20 $61

    jr   nz, jr_000_2085                          ; $200E: $20 $75
...
jr_000_210A:
    ...
    ld   hl, $214B                                ; $210C: $21 $4B $21
    ld   e, a                                     ; $210F: $5F
    ld   hl, $2000                                ; $2110: $21 $00 $20
    nop                                           ; $2113: $00
...
jr_000_2118:
    ...
    ld   hl, $2187                                ; $211A: $21 $87 $21
    sbc  e                                        ; $211D: $9B

jr_000_211E:
    ld   hl, $2000                                ; $211E: $21 $00 $20

Call_000_2121:
    nop                                           ; $2121: $00
    jr   nz, jr_000_211E                          ; $2122: $20 $FA
...
jr_000_21D2:
    ...
    ld   c, a                                     ; $21E2: $4F
    call Call_000_043B                            ; $21E3: $CD $3B $04
    ret                                           ; $21E6: $C9
...
Call_000_228E:
    ...
    ld   e, a                                     ; $22A5: $5F
    call Call_000_22FA                            ; $22A6: $CD $FA $22
    ret                                           ; $22A9: $C9
...
jr_000_237D:
    jr   nz, jr_000_237F                          ; $237D: $20 $00

Call_000_237F:
jr_000_237F:
    jr   nz, jr_000_2316                          ; $237F: $20 $95
...
Jump_000_307F:
    ...
    call Call_000_33FC                            ; $308E: $CD $FC $33
...
Call_000_30BA:
    ...
    call Call_000_33FC                            ; $30E1: $CD $FC $33
    ...
    call Call_000_33FC                            ; $3100: $CD $FC $33
...
Jump_000_311D:
    ...
    call Call_000_33FC                            ; $312C: $CD $FC $33
    ...
    call Call_000_33FC                            ; $314B: $CD $FC $33
    ...
    call Call_000_33FC                            ; $3177: $CD $FC $33
    ...
    call Call_000_33FC                            ; $3196: $CD $FC $33
    ...
    call Call_000_33FC                            ; $31C2: $CD $FC $33
    ...
    call Call_000_33FC                            ; $31E1: $CD $FC $33
    ...
    call Call_000_33FC                            ; $320D: $CD $FC $33
...
Jump_000_3222:
    ...
    call Call_000_33FC                            ; $322C: $CD $FC $33
    ...
    call Call_000_33FC                            ; $3258: $CD $FC $33
    ...
    call Call_000_33FC                            ; $3277: $CD $FC $33
...
Call_000_3286:
    ...
    call Call_000_33FC                            ; $32A3: $CD $FC $33
...
Jump_000_32C2:
    call Call_000_33FC                            ; $32C2: $CD $FC $33
...
Jump_000_33CB:
    ...
    call Call_000_340D                            ; $33CE: $CD $0D $34
...
Jump_000_33E3:
    ...
    call Call_000_33FC                            ; $33ED: $CD $FC $33
    pop  hl                                       ; $33F0: $E1
    call Call_000_3308                            ; $33F1: $CD $08 $33
    ld   bc, $0006                                ; $33F4: $01 $06 $00
    call Call_000_33FC                            ; $33F7: $CD $FC $33
    ei                                            ; $33FA: $FB
    ret                                           ; $33FB: $C9
