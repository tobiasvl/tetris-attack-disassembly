...
jr_011_4328::
    ...
    nop                                           ; $432A: $00
    add  d                                        ; $432B: $82
    ld   bc, Call_000_0301                        ; $432C: $01 $01 $03
    nop                                           ; $432F: $00
    sub  l                                        ; $4330: $95
    DB   $10                                      ; $4331: $10
    ld   a, b                                     ; $4332: $78
...
jr_011_443B::
    ...
    add  b                                        ; $4446: $80
    nop                                           ; $4447: $00
    ld   bc, jr_000_04FF                          ; $4448: $01 $FF $04
...
jr_011_44B6::
    ...
    nop                                           ; $44CC: $00
    sbc  e                                        ; $44CD: $9B
    ld   bc, Jump_000_0402                        ; $44CE: $01 $02 $04
    nop                                           ; $44D1: $00
    nop                                           ; $44D2: $00
...
jr_011_47F7::
    ...
    cp   $00                                      ; $47FF: $FE $00
    DB   $10                                      ; $4801: $10
    ld   [Call_000_0408], sp                      ; $4802: $08 $08 $04
    ldh  a, [c]                                   ; $4805: $F2
    cp   $00                                      ; $4806: $FE $00
    nop                                           ; $4808: $00
    jr   nz, @+$01                                ; $4809: $20 $FF
...
jr_011_4987::
    ...
    cp   $00                                      ; $49C7: $FE $00
    DB   $10                                      ; $49C9: $10
    ld   [Call_000_0408], sp                      ; $49CA: $08 $08 $04
    add  d                                        ; $49CD: $82
    cp   $00                                      ; $49CE: $FE $00
    nop                                           ; $49D0: $00
    jr   nz, @+$01                                ; $49D1: $20 $FF
...
jr_011_4B55::
    ...
    ld   [Call_000_0408], sp                      ; $4B76: $08 $08 $04
    inc  b                                        ; $4B79: $04
    ld   c, $11                                   ; $4B7A: $0E $11
...
jr_011_4C1F::
    ...
    ld   [Call_000_0404], sp                      ; $4C38: $08 $04 $04
    ld   [bc], a                                  ; $4C3B: $02
    dec  b                                        ; $4C3C: $05
    nop                                           ; $4C3D: $00
    add  e                                        ; $4C3E: $83
...
jr_011_4C8B::
    ...
    jp   nc, Call_000_030C                        ; $4CB3: $D2 $0C $03
    ...
    rra                                           ; $4CEB: $1F
    rlca                                          ; $4CEC: $07
    ld   bc, Jump_000_0F0F                        ; $4CED: $01 $0F $0F
    rla                                           ; $4CF0: $17
    add  hl, hl                                   ; $4CF1: $29
    ld   [hl+], a                                 ; $4CF2: $22
    ldh  [c], a                                   ; $4CF3: $E2
...
jr_011_5156::
    ...
    inc  e                                        ; $5157: $1C
    rlca                                          ; $5158: $07
    ld   bc, Call_000_0301                        ; $5159: $01 $01 $03
    rrca                                          ; $515C: $0F
    rst  $38                                      ; $515D: $FF
    cp   $01                                      ; $515E: $FE $01
    cp   $90                                      ; $5160: $FE $90
...
jr_011_51AA::
    ...
    ld   [jr_000_0D1C], sp                        ; $51BE: $08 $1C $0D
    ld   b, $0F                                   ; $51C1: $06 $0F
...
jr_011_5270::
    ...
    nop                                           ; $527A: $00
    ld   bc, Call_000_0307                        ; $527B: $01 $07 $03
...
jr_011_54B5::
    ...
    ld   hl, Jump_000_02C2                        ; $54BB: $21 $C2 $02
    nop                                           ; $54BE: $00
    nop                                           ; $54BF: $00
    rlca                                          ; $54C0: $07
...
jr_011_5529::
    ld   bc, Jump_000_0402                        ; $5529: $01 $02 $04
    nop                                           ; $552C: $00
    nop                                           ; $552D: $00
    rlca                                          ; $552E: $07
    jr   @-$1E                                    ; $552F: $18 $E0
...
jr_011_56C2::
    ...
    ld   [hl-], a                                 ; $575B: $32
    inc  l                                        ; $575C: $2C
    ld   [Jump_000_06FF], sp                      ; $575D: $08 $FF $06
    nop                                           ; $5760: $00
    add  d                                        ; $5761: $82
    rra                                           ; $5762: $1F
    ...
    nop                                           ; $576B: $00
    nop                                           ; $576C: $00
    ld   bc, Jump_000_0402                        ; $576D: $01 $02 $04
    ld   a, $4F                                   ; $5770: $3E $4F
    cp   a                                        ; $5772: $BF
    ld   a, $47                                   ; $5773: $3E $47
    cp   a                                        ; $5775: $BF
...
jr_011_5791::
    ...
    ld   [Call_000_0408], sp                      ; $57FB: $08 $08 $04
    rra                                           ; $57FE: $1F
    ccf                                           ; $57FF: $3F
    rra                                           ; $5800: $1F
    ld   b, $00                                   ; $5801: $06 $00
...
jr_011_588D::
    ...
    cp   $FE                                      ; $58F0: $FE $FE
    DB   $EC                                      ; $58F2: $EC
    ld   [Jump_000_06FF], sp                      ; $58F3: $08 $FF $06
    nop                                           ; $58F6: $00
    add  d                                        ; $58F7: $82
    rra                                           ; $58F8: $1F
    rst  $38                                      ; $58F9: $FF
...
jr_011_5B0C::
    ...
    ld   hl, Jump_000_1212                        ; $5B1C: $21 $12 $12
    sub  d                                        ; $5B1F: $92
    DB   $FC                                      ; $5B20: $FC
    xor  b                                        ; $5B21: $A8
    ld   b, $00                                   ; $5B22: $06 $00
...
jr_011_5D7C::
    ...
    add  b                                        ; $5D97: $80
    nop                                           ; $5D98: $00
    ld   bc, Call_000_0302                        ; $5D99: $01 $02 $03
    ld   bc, $F161                                ; $5D9C: $01 $61 $F1
    ldh  a, [c]                                   ; $5D9F: $F2
    ld   [Call_000_0404], sp                      ; $5DA0: $08 $04 $04
...
jr_011_5E0A::
    ...
    rst  $00                                      ; $5E32: $C7
    push bc                                       ; $5E33: $C5
    jp   Call_000_04E2                            ; $5E34: $C3 $E2 $04
...
jr_011_69C5::
    ...
    rlca                                          ; $69D3: $07
    ld   bc, Jump_000_0400                        ; $69D4: $01 $00 $04
    ld   [bc], a                                  ; $69D7: $02
    ld   b, $07                                   ; $69D8: $06 $07
    dec  bc                                       ; $69DA: $0B
    ld   e, [hl]                                  ; $69DB: $5E
...
jr_011_6D44::
    ...
    ld   [hl-], a                                 ; $6D54: $32
    jp   nc, Call_000_0007                        ; $6D55: $D2 $07 $00
...
jr_011_6EA1::
    ...
    ld   h, b                                     ; $6EC1: $60
    DB   $10                                      ; $6EC2: $10
    ld   [Call_000_0404], sp                      ; $6EC3: $08 $04 $04
    ld   [bc], a                                  ; $6EC6: $02
    ld   [bc], a                                  ; $6EC7: $02
...
jr_011_7128::
    ...
    ld   [Call_000_1020], sp                      ; $7179: $08 $20 $10
    nop                                           ; $717C: $00
...
jr_011_717D::
    ...
    ld   [Call_000_1020], sp                      ; $7188: $08 $20 $10
    nop                                           ; $718B: $00
...
jr_011_7219::
    ...
    DB   $FC                                      ; $721E: $FC
    inc  b                                        ; $721F: $04
    ld   [Call_000_1818], sp                      ; $7220: $08 $18 $18
...
jr_011_7368::
    ...
    inc  hl                                       ; $7384: $23
    DB   $10                                      ; $7385: $10
    ld   [Call_000_0307], sp                      ; $7386: $08 $07 $03
    nop                                           ; $7389: $00
    ld   a, [hl]                                  ; $738A: $7E
    cp   h                                        ; $738B: $BC
    rst  $38                                      ; $738C: $FF
    ...
    inc  hl                                       ; $739C: $23
    DB   $10                                      ; $739D: $10
    ld   [Call_000_0307], sp                      ; $739E: $08 $07 $03
    nop                                           ; $73A1: $00
    rst  $20                                      ; $73A2: $E7
    set  7, a                                     ; $73A3: $CB $FF
    nop                                           ; $73A5: $00
...
Call_011_73D2::
    ...
    ld   [Call_000_1004], sp                      ; $73F4: $08 $04 $10
