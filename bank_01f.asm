...
jr_01F_611F::
    ...
    ld   bc, Call_000_0302                        ; $61E3: $01 $02 $03
    inc  b                                        ; $61E6: $04
    ld   b, $09                                   ; $61E7: $06 $09
    inc  c                                        ; $61E9: $0C
    rrca                                          ; $61EA: $0F
...
jr_01F_62B9::
    ...
    inc  sp                                       ; $62BC: $33
    ld   [hl-], a                                 ; $62BD: $32
    ld   sp, Jump_000_2F30                        ; $62BE: $31 $30 $2F
    ld   l, $2D                                   ; $62C1: $2E $2D
...
jr_01F_6A21::
    ld   [Call_000_3800], sp                      ; $6A21: $08 $00 $38
...
jr_01F_72C2::
    ...
    DB   $10                                      ; $72E3: $10
    ld   de, Jump_000_2222                        ; $72E4: $11 $22 $22
    ld   b, h                                     ; $72E7: $44
    pop  hl                                       ; $72E8: $E1
    ld   [de], a                                  ; $72E9: $12
    inc  c                                        ; $72EA: $0C
...
jr_01F_730D::
    ...
    rst  $38                                      ; $732E: $FF
    nop                                           ; $732F: $00
    ld   bc, Call_000_0301                        ; $7330: $01 $01 $03
    inc  bc                                       ; $7333: $03
    rlca                                          ; $7334: $07
    ld   a, [bc]                                  ; $7335: $0A
    ld   [de], a                                  ; $7336: $12
...
jr_01F_73D3::
    ...
    ld   b, b                                     ; $73E4: $40
    nop                                           ; $73E5: $00
    ld   [Jump_000_282C], a                       ; $73E6: $EA $2C $28
...
jr_01F_7778::
    ...
    nop                                           ; $778C: $00
    ld   bc, Jump_000_0803                        ; $778D: $01 $03 $08
    adc  b                                        ; $7790: $88
    add  hl, bc                                   ; $7791: $09
...
jr_01F_7804::
    ...
    dec  b                                        ; $780F: $05
    ld   bc, Call_000_0286                        ; $7810: $01 $86 $02
    inc  b                                        ; $7813: $04
...
jr_01F_78F9::
    ...
    DB   $10                                      ; $790E: $10
    ld   de, Jump_000_2222                        ; $790F: $11 $22 $22
    ld   b, h                                     ; $7912: $44
    pop  hl                                       ; $7913: $E1
    ld   [de], a                                  ; $7914: $12
    inc  c                                        ; $7915: $0C
...
jr_01F_7973::
    ...
    inc  c                                        ; $7978: $0C
    or   a                                        ; $7979: $B7
    ld   [Call_000_1818], sp                      ; $797A: $08 $18 $18
...
jr_01F_79FE::
    ...
    ld   b, b                                     ; $7A0F: $40
    nop                                           ; $7A10: $00
    ld   [Jump_000_282C], a                       ; $7A11: $EA $2C $28
...
jr_01F_7A1A::
    ...
    rrca                                          ; $7A50: $0F
    inc  bc                                       ; $7A51: $03
    ld   bc, Jump_000_0400                        ; $7A52: $01 $00 $04
    inc  bc                                       ; $7A55: $03
