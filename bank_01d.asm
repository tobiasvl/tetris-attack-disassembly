...
jr_01D_48F8:
    ...
    ld   [bc], a                                  ; $4985: $02
    call nc, Call_000_1268                        ; $4986: $D4 $68 $12
    adc  b                                        ; $4989: $88
    ld   h, c                                     ; $498A: $61
...
jr_01D_52AC:
    ...
    nop                                           ; $52B5: $00
    cp   h                                        ; $52B6: $BC
    jp   c, Jump_000_0224                         ; $52B7: $DA $24 $02
...
jr_01D_622B:
    ...
    ld   l, b                                     ; $6231: $68
    inc  de                                       ; $6232: $13
    ld   bc, $0408                                ; $6233: $01 $08 $04
    ld   [$0400], sp                              ; $6236: $08 $00 $04
    ld   [bc], a                                  ; $6239: $02
    inc  b                                        ; $623A: $04
    ld   [bc], a                                  ; $623B: $02
    nop                                           ; $623C: $00
...
jr_01D_635D:
    ...
    ld   l, b                                     ; $6391: $68
    inc  de                                       ; $6392: $13
    ld   bc, $0408                                ; $6393: $01 $08 $04
    ld   [$0400], sp                              ; $6396: $08 $00 $04
    ld   [bc], a                                  ; $6399: $02
    inc  b                                        ; $639A: $04
    ld   [bc], a                                  ; $639B: $02
    nop                                           ; $639C: $00
...
jr_01D_7CDB:
    ...
    ld   l, b                                     ; $7CE1: $68
    inc  de                                       ; $7CE2: $13
    ld   bc, $0408                                ; $7CE3: $01 $08 $04
    ld   [$0400], sp                              ; $7CE6: $08 $00 $04
    ld   [bc], a                                  ; $7CE9: $02
    inc  b                                        ; $7CEA: $04
    ld   [bc], a                                  ; $7CEB: $02
    nop                                           ; $7CEC: $00
