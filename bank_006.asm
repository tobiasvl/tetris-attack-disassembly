...
jr_006_40A8::
    ...
    sub  h                                        ; $4141: $94
    nop                                           ; $4142: $00
    ld   bc, Call_000_0302                        ; $4143: $01 $02 $03
    inc  b                                        ; $4146: $04
    dec  b                                        ; $4147: $05
    ld   b, $07                                   ; $4148: $06 $07
...
jr_006_41CA::
    ...
    adc  $DA                                      ; $41E2: $CE $DA
    DB   $DB                                      ; $41E4: $DB
    call c, Jump_006_7F7F                         ; $41E5: $DC $7F $7F
    ld   a, a                                     ; $41E8: $7F
    ld   a, a                                     ; $41E9: $7F
    ld   a, a                                     ; $41EA: $7F
    ld   a, a                                     ; $41EB: $7F
...
jr_006_42E9::
    ...
    sub  h                                        ; $430F: $94
    nop                                           ; $4310: $00
    ld   bc, Call_000_0302                        ; $4311: $01 $02 $03
    inc  b                                        ; $4314: $04
    dec  b                                        ; $4315: $05
    inc  e                                        ; $4316: $1C
    add  b                                        ; $4317: $80
...
jr_006_4328::
    ...
    adc  d                                        ; $4393: $8A
    ld   d, a                                     ; $4394: $57
    ld   hl, jr_000_2322                          ; $4395: $21 $22 $23
    inc  h                                        ; $4398: $24
    dec  h                                        ; $4399: $25
    and  $E7                                      ; $439A: $E6 $E7
...
Call_006_46CC::
    ...
    sub  h                                        ; $472A: $94
    rra                                           ; $472B: $1F
    ld   bc, Call_000_0302                        ; $472C: $01 $02 $03
    inc  b                                        ; $472F: $04
    dec  b                                        ; $4730: $05
    ld   b, $07                                   ; $4731: $06 $07
    add  $7F                                      ; $4733: $C6 $7F
...
jr_006_4B85::
    ...
    add  [hl]                                     ; $4BD4: $86
    DB   $10                                      ; $4BD5: $10
    ld   bc, Call_000_0302                        ; $4BD6: $01 $02 $03
    inc  b                                        ; $4BD9: $04
    dec  b                                        ; $4BDA: $05
    inc  b                                        ; $4BDB: $04
...
jr_006_4C5C::
    ...
    ld   b, $13                                   ; $4D06: $06 $13
    add  c                                        ; $4D08: $81
    ld   de, Call_006_7F0C                        ; $4D09: $11 $0C $7F
    adc  c                                        ; $4D0C: $89
    DB   $EC                                      ; $4D0D: $EC
    xor  $EF                                      ; $4D0E: $EE $EF
    and  d                                        ; $4D10: $A2
...
Jump_006_4D43::
    ...
    and  $E7                                      ; $4D4C: $E6 $E7
    dec  bc                                       ; $4D4E: $0B
    ld   a, [Call_006_7F0C]                       ; $4D4F: $FA $0C $7F
    adc  c                                        ; $4D52: $89
    rst  $38                                      ; $4D53: $FF
...
jr_006_4D9E::
    ...
    nop                                           ; $4DA8: $00
    ld   bc, Call_000_0302                        ; $4DA9: $01 $02 $03
    inc  b                                        ; $4DAC: $04
    dec  b                                        ; $4DAD: $05
    ld   b, $07                                   ; $4DAE: $06 $07
...
jr_006_56CF::
    ...
    ld   e, a                                     ; $572A: $5F
    nop                                           ; $572B: $00
    ld   bc, Call_000_0301                        ; $572C: $01 $01 $03
    rlca                                          ; $572F: $07
    rra                                           ; $5730: $1F
...
jr_006_5731::
    ...
    inc  bc                                       ; $575A: $03
    add  d                                        ; $575B: $82
    ld   bc, Call_000_0301                        ; $575C: $01 $01 $03
    nop                                           ; $575F: $00
    adc  b                                        ; $5760: $88
    DB   $EC                                      ; $5761: $EC
...
jr_006_584F::
    ...
    adc  b                                        ; $5870: $88
    ld   [hl], b                                  ; $5871: $70
    ld   bc, Call_000_0301                        ; $5872: $01 $01 $03
    rlca                                          ; $5875: $07
    ld   [hl+], a                                 ; $5876: $22
    ld   h, b                                     ; $5877: $60
    ld   b, b                                     ; $5878: $40
...
jr_006_5B9B::
    ...
    ld   b, $00                                   ; $5BA2: $06 $00
    add  d                                        ; $5BA4: $82
    ld   [Call_000_03DC], sp                      ; $5BA5: $08 $DC $03
    nop                                           ; $5BA8: $00
    adc  e                                        ; $5BA9: $8B
...
jr_006_61A1::
    ...
    DB   $EC                                      ; $61B0: $EC
    pop  af                                       ; $61B1: $F1
    ld   bc, Call_000_0301                        ; $61B2: $01 $01 $03
    inc  bc                                       ; $61B5: $03
    ld   [hl], l                                  ; $61B6: $75
    cp   h                                        ; $61B7: $BC
...
jr_006_62D1::
    ...
    ld   b, $00                                   ; $62E4: $06 $00
    sub  e                                        ; $62E6: $93
    ld   bc, Call_000_0302                        ; $62E7: $01 $02 $03
...
jr_006_68D0::
    ...
    nop                                           ; $68F2: $00
    add  d                                        ; $68F3: $82
    ld   bc, Call_000_0302                        ; $68F4: $01 $02 $03
...
jr_006_6D45::
    ...
    nop                                           ; $6E3C: $00
    ld   [bc], a                                  ; $6E3D: $02
    ld   bc, Jump_000_0400                        ; $6E3E: $01 $00 $04
    ld   c, $04                                   ; $6E41: $0E $04
    nop                                           ; $6E43: $00
    nop                                           ; $6E44: $00
    add  a                                        ; $6E45: $87
...
jr_006_753E::
    ...
    ld   bc, Call_000_0307                        ; $7560: $01 $07 $03
    add  e                                        ; $7563: $83
    pop  bc                                       ; $7564: $C1
...
jr_006_765C::
    ...
    nop                                           ; $7661: $00
    inc  bc                                       ; $7662: $03
    ld   bc, Call_000_03B7                        ; $7663: $01 $B7 $03
    inc  bc                                       ; $7666: $03
    ld   b, $84                                   ; $7667: $06 $84
    sub  c                                        ; $7669: $91
    add  h                                        ; $766A: $84
